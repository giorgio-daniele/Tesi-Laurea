...
PARAMETERS = {
    ...
    "italy": [
        # Canali RAI
        { "name": "skytg24", "image": "skytg24.png", "x-val": X_OFFSET, "y-val": 0, "s-val": 0 },
        { "name": "raiuno",  "image": "raiuno.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET, "s-val": 0 },
        { "name": "raidue",  "image": "raidue.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET * 2, "s-val": 0 },
        { "name": "raitre",  "image": "raitre.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET * 3, "s-val": 0 },
        # Canali Mediaset
        { "name": "retequattro",    "image": "retequattro.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET * 4, "s-val": 0 },
        { "name": "canalecinque",   "image": "canalecinque.png", "x-val": X_OFFSET, "y-val": Y_OFFSET * 5, "s-val": 0 },
        { "name": "italiauno",      "image": "italiauno.png",    "x-val": X_OFFSET, "y-val": Y_OFFSET * 6, "s-val": 0 },
    ],

    # Define the list of all international channels 
    "globe": [
        { "name": "skysportuno",    "image": "skysportuno.png",     "x-val": X_OFFSET, "y-val": 0, "s-val": S_OFFSET },
        { "name": "skysportcalcio", "image": "skysportcalcio.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET, "s-val": 0 },
        { "name": "skysporttennis", "image": "skysporttennis.png",  "x-val": X_OFFSET, "y-val": Y_OFFSET * 2, "s-val": 0 },
        { "name": "skysportmax",    "image": "skysportmax.png",     "x-val": X_OFFSET, "y-val": Y_OFFSET * 3, "s-val": 0 },
        { "name": "skysportgolf",   "image": "skysportgolf.png",    "x-val": X_OFFSET, "y-val": Y_OFFSET * 4, "s-val": 0 },
        { "name": "skysportf1",     "image": "skysportf1.png",      "x-val": X_OFFSET, "y-val": Y_OFFSET * 5, "s-val": 0 },
    ],
}
...
class Sample():
    ...
    def __init__(self, number: int, shark: Wireshark, skygo: SkyGoMobileApp, trace: str):
...
def main(number, repetitions, interface, results_folder_name):
    ...
    for i in range(repetitions):
        ...
        service = SkyGoMobileApp(img_path=os.path.join(os.getcwd(), "images", platform))
